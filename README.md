...
Several bugs were fixed and image display was sped up. Automatic imaging cropping was improved and images can now be flipped about the middle vertical axis via a checkbox. Redundant settings such as sigma and step size were removed and replaced by block size, which can now be changed within the GUI. The latest code was tested using a Windows PC running Matlab R2022a (64-bit).
---
